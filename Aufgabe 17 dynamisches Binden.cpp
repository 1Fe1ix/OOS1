/*
	...
	Nutzen Sie die sprachlichen Möglichkeiten von C++, um den Compiler prüfen zu lassen, 
	ob virtuelle Methoden korrekt überschrieben wurden.
****************************************************************************************************************************************************************/
#include <iostream>
#include <string>
using namespace std;
...
public:
	...
	void f_4() override { p("C::f_4()", false);  f_2(); }
};

class D : public C {
public:
	void f_1() { p("D::f_1()"); }
	void f_2() override { p("D::f_2()"); }
	void f_3() override { p("D::f_3()"); }
};
